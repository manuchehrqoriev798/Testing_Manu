  ...
  return (
    <div className="visualizer">
      ...
      <div className="controls">
        ...
        {/* Insert Form */}
        <form onSubmit={handleInsertSubmit} className="inputForm">
          <input
            type="text"
            value={inputValue}
      ...
      <div className="skipListInfo">
        ...
        <ul className="legend">
          <li><span className="regularNode"></span> Regular Node</li>
          <li><span className="highlightedNode"></span> Highlighted Node</li>
          <li><span className="deletingNode"></span> Deleting Node</li>
        </ul>
      </div>
