  ...
  return (
    ...
    >
      ...
      <div className={styles.nodeContent}>
        ...
        <div className={styles.colorIndicator}>{data.color}</div>
      </div>
...
const RedBlackTreeVisualizerContent = ({ onBack }) => {
  // Node types registration
  const nodeTypes = useRef({ rbNode: RedBlackTreeNode }).current;
