...
const BufferCellNode = ({ data }) => {
  return (
    ...
    >
      {data.isHead && <div className={styles.headIndicator}>HEAD</div>}
      {data.isTail && <div className={styles.tailIndicator}>TAIL</div>}
      
      <div className={styles.cellContent}>
        {!data.isEmpty ? (
          <div className={styles.cellValue}>{data.value}</div>
        ) : (
          <div className={styles.emptyIndicator}>Empty</div>
        )}
      </div>
      <div className={styles.cellIndex}>{data.index}</div>
    </div>
  );
};

// Main content component
const CircularBufferVisualizerContent = ({ onBack }) => {
  // Node types
  ...
  return (
    <div className={styles.visualizer}>
      ...
      <div className={styles.sizeControls}>
        <div className={styles.sizeTitle}>Buffer Size:</div>
...
export default CircularBufferVisualizer; 