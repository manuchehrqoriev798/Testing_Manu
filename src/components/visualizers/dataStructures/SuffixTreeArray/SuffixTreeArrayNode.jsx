...
import './SuffixTreeArrayNode.css';
    ...
    >
      ...
      <div className="nodeContent">
        ...
        {data.suffixIndex !== undefined && (
          <div className="suffixIndex">Suffix: {data.suffixIndex}</div>
        )}
      </div>
...
const SuffixArrayNode = ({ data }) => {
  return (
    ...
    >
      <div className="indexLabel">{data.index}</div>
      <div className="arrayContent">
        <div className="suffixPos">Position: {data.suffixPos}</div>
        <div className="suffixText">{data.suffixText}</div>
      </div>
    </div>
  );
};
...
const SuffixTreeArrayNode = ({ onBack }) => {
  ...
  return (
    <div className="visualizer">
      ...
      <div className="controls">
        ...
        <form onSubmit={handleInputSubmit} className="inputForm">
          <input
            type="text"
            value={inputString}
        ...
        <form onSubmit={handleSearchSubmit} className="inputForm">
          <input
            type="text"
            value={searchPattern}
...
export default SuffixTreeArrayNode; 