...
const BSTNode = ({ data }) => {
  return (
    ...
    >
      ...
      <div className="nodeValue">{data.value}</div>
      <Handle type="source" position={Position.Bottom} id="left" className="handleLeft" />
      <Handle type="source" position={Position.Bottom} id="right" className="handleRight" />
    </div>
  );
};

// Main BST visualizer component
const BSTNode = ({ onBack }) => {
