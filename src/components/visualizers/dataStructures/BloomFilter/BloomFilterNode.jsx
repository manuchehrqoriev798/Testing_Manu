...
import './BloomFilterNode.css';

// Custom Bit Node component
const BitNode = ({ data }) => {
  return (
    <div className={`${styles.bitNode} ${data.isSet ? styles.setBit : styles.unsetBit}`}>
      <div className="nodeIndex">{data.index}</div>
      <div className="nodeValue">{data.isSet ? '1' : '0'}</div>
      {data.isHighlighted && (
        <div className="highlightRing" style={{ backgroundColor: data.highlightColor }}></div>
      )}
    </div>
  );
};
  ...
  return (
    <div className="hashNode">
      ...
      <div className="hashFunction">
        <div className="hashTitle">Hash Function {data.index}</div>
        <div className="hashFormula">h{data.index}(x) = {data.formula}</div>
      </div>
  ...
  return (
    <div className="visualizer">
      ...
      <div className="controls">
        ...
        <form onSubmit={handleAddSubmit} className="inputForm">
          <input
            type="text"
            value={inputValue}
        ...
        <form onSubmit={handleCheckSubmit} className="inputForm">
          <input
            type="text"
            value={searchValue}
...
export default BloomFilterNode; 